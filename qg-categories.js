...
(function () {
  var CATEGORIES = [
    ...
    { id: 'beauty', label: 'Beauty', icon: '💇', iconKey: 'scissors', bg: 'color-mix(in srgb, var(--teal) 15%, transparent)', desc: 'Hair, nails, and personal care', requires_enhanced_verification: false },
    ...
    { id: 'events', label: 'Events', icon: '🎉', iconKey: 'party', bg: 'color-mix(in srgb, var(--teal) 15%, transparent)', desc: 'Party help, setup, and event support', requires_enhanced_verification: false },
    ...
    { id: 'other', label: 'Other', icon: '📦', iconKey: 'package', bg: 'color-mix(in srgb, var(--text) 6%, transparent)', desc: 'Everything else on SwiftGigs', requires_enhanced_verification: false }
  ];
  ...
  window.getCatInfo = function (cat) {
    ...
    return MAP[k] || { id: k || 'other', label: cat || 'Other', icon: '📦', iconKey: 'package', bg: 'color-mix(in srgb, var(--text) 6%, transparent)', desc: '', requires_enhanced_verification: false };
  };
})();
